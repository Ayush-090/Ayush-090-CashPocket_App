...
st.image("https://example.com/logo.png", width=200)  # Replace with your actual logo URL
...
with tab2:
    ...
    if loan_amount:
        ...
        if loan_paid:
            ...
            contact_number = st.text_input("+91-9876543210")
...
st.markdown("<h4 style='font-size:22px; font-weight:bold;'>CHANDIGARH UNIVESITY</h4>", unsafe_allow_html=True)
